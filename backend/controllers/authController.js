...
import { generateDigitalId } from '../utils/generateId.js';
...
export const register = asyncHandler(async (req, res, next) => {
  ...
  // Generate digital ID
  const idNumber = generateDigitalId();
...
export const getMe = asyncHandler(async (req, res, next) => {
  const user = await User.findById(req.user.id).populate({
    path: 'digitalId',
    select: 'idNumber qrCode issuedDate expiryDate status verificationLevel'
  });
